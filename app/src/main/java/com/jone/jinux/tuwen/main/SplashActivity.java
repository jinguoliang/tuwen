...
public class SplashActivity extends BaseActivity {
	...
	private void runApp() {
		//初始化SDK
		AdManager.getInstance(mContext).init("85aa56a59eac8b3d", "a14006f66f58d5d7", true, true);
		//设置开屏
		setupSplashAd();
	}
		...
		SpotManager.getInstance(mContext)
				.showSplash(mContext, splashViewSettings, new SpotListener() {
					...
					public void onShowSuccess() {
						...
						splashLayout.startAnimation(AnimationUtils.loadAnimation(mContext, android.R.anim.fade_in));
					}
